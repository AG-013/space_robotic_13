...
################ CHANGE STATES FUNCTIONING HIGH LEVEL ############################################################################################################
 ...
 ##############################################################################################################################################################################    
    ...
    def handle_selecting_frontier(self):
        ...
        frontier_costs = [(frontier, self.frontier_cost(frontier)) for frontier in filtered_frontier if frontier is not None and len(frontier) > 0]
        
        # print('frontier costs:', frontier_costs)
