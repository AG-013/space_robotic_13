...
class CaveExplorer:
    ...
    def move_to_frontier(self, frontier):
        ...
        # Move forward 10m
        pose_2d.x = frontier[0] * map_resolution + map_origin.x # frontier[0] = x
        pose_2d.y = frontier[1] * map_resolution + map_origin.y # frontier[1] = y
    ...
    def handle_timeout(self):
        ...
        # Wait for action client to acknowledge cancellation
        while self.move_base_action_client_.get_state() == actionlib.GoalStatus.ACTIVE:
            rospy.loginfo("Waiting for goal to be canceled...")
            rospy.sleep(0.1)
